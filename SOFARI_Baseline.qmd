...
The hypotheses presented in @tbl-hypotheses posit that the variables of interest will be associated with *clinically important* differences in FAOS subscales. One study [@tapaninaho2022] examined changes in FAOS after foot and ankle surgery in a relatively small sample (N = 134) and reported the following MIC differences using logistic modeling on each subscale separately.

Another small study [@desai2019]

::: {#tbl-mcid}
\
Minimal important changes in FAOS after surgery
:::
