...
fit_faos_models <- function(imputed_data, 
                           ...
                           full_covariates = c("Region","AgeAtInitialExam", "Sex2", 
...
create_faos_plots <- function(models, 
  ...
  if(is.null(subscale_names)) {
    # Use original model names if no custom names provided
    plot_subscale_names <- names(models)
  } else {
    # Validate that subscale_names length matches models length
  ...
  # Create plots
  plots <- map2(models, plot_subscale_names, function(model, subscale_name) {
